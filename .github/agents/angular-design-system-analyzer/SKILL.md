---
name: angular-design-system-analyzer
...
# Angular Design System Analyzer
...
1. **Clone or access the Angular design system repository**
   - If given a GitHub URL, clone it: `git clone <url> /home/ubuntu/design-system`
   - If given a local path, use it directly

2. **Run structure analysis**
   \`\`\`bash
   python3.11 /home/ubuntu/skills/angular-design-system-analyzer/scripts/analyze_structure.py <repo_path> structure.json
   \`\`\`
...
3. **Extract component information**
   \`\`\`bash
   python3.11 /home/ubuntu/skills/angular-design-system-analyzer/scripts/extract_components.py <repo_path> components.json
   \`\`\`
...
4. **Analyze styles and theming**
   \`\`\`bash
   python3.11 /home/ubuntu/skills/angular-design-system-analyzer/scripts/analyze_styles.py <repo_path> styles.json
   \`\`\`
...
5. **Detect code patterns**
   \`\`\`bash
   python3.11 /home/ubuntu/skills/angular-design-system-analyzer/scripts/detect_patterns.py <repo_path> patterns.json
   \`\`\`
...
6. **Generate AI rules for code review**
   \`\`\`bash
   python3.11 /home/ubuntu/skills/angular-design-system-analyzer/scripts/generate_ai_rules.py structure.json components.json styles.json patterns.json ai_rules.md
   \`\`\`
...
1. **Use the component template**:
   \`\`\`bash
   cp /home/ubuntu/skills/angular-design-system-analyzer/templates/component-template.component.\* <destination>/
   \`\`\`
